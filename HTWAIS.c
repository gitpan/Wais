 ...
 * Last Modified On: Fri Nov 10 17:21:10 1995
 * Language        : C
 * Update Count    : 205
...
int 
WAISsearch (host, port, database, keywords,
     ...
     STR            *texts;
{
  ...
  if (!interpret_message (request_message,
    ...
    display_search_response (diagnostics, headlines, texts,
			     query_response, database, keywords);
    if (query_response) {
